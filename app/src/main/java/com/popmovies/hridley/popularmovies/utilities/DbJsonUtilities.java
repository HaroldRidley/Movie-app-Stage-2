...
import com.popmovies.hridley.popularmovies.models.*;
 ...
 */
public final class DbJsonUtilities {
    ...
    private static final String TAG = DbJsonUtilities.class.getSimpleName();
